...
Route::middleware(['setLanguage','auth'])->group(function () {
...
Route::prefix('admin')->middleware('auth', 'xss', 'checkUserStatus', 'checkImpersonateUser')->group(function () {
    ...
    Route::middleware('permission:manage_patient_visits')->group(function () {
        ...
        // the history_of_present_illness
        Route::post('add-history_of_present_illness', [VisitController::class, 'add_history_of_present_illness'])->name('add.history_of_present_illness');
        Route::post('delete-history_of_present_illness/{history_of_present_illness}',[VisitController::class, 'delete_history_of_present_illness'])->name('delete.history_of_present_illness');

        // the drug_history
        Route::post('add-drug_history', [VisitController::class, 'add_drug_history'])->name('add.drug_history');
        Route::post('delete-drug_history/{drug_history}',[VisitController::class, 'delete_drug_history'])->name('delete.drug_history');

        // the family_history
        Route::post('add-family_history', [VisitController::class, 'add_family_history'])->name('add.family_history');
        Route::post('delete-family_history/{family_history}',[VisitController::class, 'deleteProblem'])->name('delete.problem');

        // the past_history
        Route::post('add-past_history', [VisitController::class, 'add_past_history'])->name('add.past_history');
        Route::post('delete-past_history/{past_history}',[VisitController::class, 'delete_past_history'])->name('delete.past_history');

        // the diagnosis

        Route::post('add-diagnosis', [VisitController::class, 'add_diagnosis'])->name('add.diagnosis');
        Route::post('delete-diagnosis/{diagnosis}',[VisitController::class, 'delete_diagnosis'])->name('delete.diagnosis');

        // the investigation

        Route::post('add-investigation', [VisitController::class, 'add_investigation'])->name('add.investigation');
        Route::post('delete-investigation/{investigation}',[VisitController::class, 'delete_investigation'])->name('delete.investigation');

        // the ray_report

        Route::post('add-ray_report', [VisitController::class, 'add_ray_report'])->name('add.ray_report');
        Route::post('delete-ray_report/{ray_report}',[VisitController::class, 'delete_ray_report'])->name('delete.ray_report');

        // the treatment

        Route::post('add-treatment', [VisitController::class, 'add_treatment'])->name('add.treatment');
        Route::post('delete-treatment/{treatment}',[VisitController::class, 'delete_treatment'])->name('delete.treatment');


        Route::post('add-review', [VisitController::class, 'add_review'])->name('add.review');
        Route::post('delete-review/{problem}',[VisitController::class, 'delete_review'])->name('delete.delete_review');
    });
