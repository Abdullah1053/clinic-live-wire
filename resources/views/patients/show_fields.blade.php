...
<div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.setting.age')  }}</label>
    <span class="fs-4 text-gray-800">{{ !empty($patient->user->age) ? $patient->user->age : __('messages.common.n/a') }}</span>
</div>
<div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.setting.weight')  }}</label>
    <span class="fs-4 text-gray-800">{{ !empty($patient->user->weight) ? $patient->user->weight : __('messages.common.n/a') }}</span>
</div>
{{--  --}}
<div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
