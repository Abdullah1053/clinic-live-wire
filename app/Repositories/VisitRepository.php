...
class VisitRepository extends BaseRepository
{
    ...
    {
        return Visit::with([
            'visitDoctor.user', 'visitPatient.user', 'problems', 'observations', 'notes', 'prescriptions','diagnosis','family_history','history_of_present_illness',
            'investigation','drug_history','past_history','ray_report','review','treatment'
        ])->findOrFail($id);
    }
}
